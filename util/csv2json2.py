...
R_TRAIN_PATH = "../csv/iris-std-train.csv"
R_TEST_PATH = "../csv/iris-std-test.csv"
W_TRAIN_PATH = "../json/iris-std-train.json"
W_TEST_PATH = "../json/iris-std-test.json"
